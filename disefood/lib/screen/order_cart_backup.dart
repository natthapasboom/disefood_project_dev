...
//     db.watchCartModel.listen((event) {
//       print("~ ====>  ${event[0].foodId} ${event[0].foodName}");
//     });
...
//   Future<List<CartModel>> readSQLite() async {
...
//                             print("SN Has Data: ${snapshot.data[0].foodId}");
...
//                                   print(
//                                       "=====> ${cartItem.foodName}  ${cartItem.foodQuantity}");
//                                   return Container(
//                                     child: Column(
//                                       children: [
//                                         Container(
