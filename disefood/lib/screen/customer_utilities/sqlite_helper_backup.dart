...
//   final _cartController = StreamController<List<CartModel>>.broadcast();
//   Stream<List<CartModel>> get watchCartModel => _cartController.stream;

//   watchAll() async {
//     _cartController.sink.add(await readAllDataFromSQLite());
//   }

//   fetchAllDataFromSQLite() async {
//     Database database = await connectedDatabase();
//     List<CartModel> cartModels = List();
//     List<Map<String, dynamic>> maps = await database.query(tableDatabase);
...
//     _cartController.sink.add(cartModels);

//     print("After Add to Stream ===> !!!");
//   }
