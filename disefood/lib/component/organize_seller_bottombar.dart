...
class OrganizeSeller extends StatefulWidget {

  @override
  _OrganizeSellerState createState() => _OrganizeSellerState();
}

class _OrganizeSellerState extends State<OrganizeSeller> {
  int selectIndex = 1;
  final widgetOptions = [
    OrderSellerPage(),
    OrganizeSellerPage(),
